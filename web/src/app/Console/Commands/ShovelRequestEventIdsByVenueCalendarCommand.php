...
// http://usabmx.com/tracks/'.$this->venuePageId.'/events/schedule?'.http_build_query(
//             [
//             'mode'  => 'calendar',
//             'month' => $this->month,
//             'year'  => $this->year,
...
class ShovelRequestEventIdsByVenueCalendarCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'shovel:request-event-ids-by-venue-calendar
                            {--venue_id= : Venue id.}
     ...
     * @var string
     */
    protected $description = 'Request Event Ids by Venue calendar.';
