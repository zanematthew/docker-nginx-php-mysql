...
class ShovelRequestEventIdsByTypeCommand extends Command
{
    use \App\ShovelTrait;
     ...
     * @var string
     */
    protected $signature = 'shovel:request-event-ids-by-type
                            ...
                            {--a|all : Submit request based on exiting Event Types.}';
